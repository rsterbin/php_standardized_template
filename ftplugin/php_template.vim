...
" Vim filetype plugin file for code templates for PHP 5 development.  Coding
" standards can be defined using a directory variable called php_template_config.
